...
export default function ProductList() {
  ...
  return (
    <div>
      <br></br>
      <p className="title">신규 제품 등록 </p> 제품명:
      <input type="text" name="productName" value={product.productName} placeholder="제품명" onChange={handleProduct} />
      가격:
      <input type="text" name="price" value={product.price} placeholder="0" onChange={handleProduct} />
      <button onClick={handleSave}>저장</button>
      <button onClick={initProductInput}>초기화</button>
      <hr></hr>
